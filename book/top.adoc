...
過去20年以上にわたる東方Projectの楽曲、キャラ(人妖)の人気投票データからの目で見てわかるパターンの抽出とそれを説明する数理モデルの提唱と解析を行いました。
...
で https://toho-vote.info/result のデータを整形しgithubのdata以下に置いてあります。
...
- integertitles.csv 整数タイトル一覧
- nonintegertitles.csv 非整数タイトル一覧

- char_noninteger_list.csv 非整数タイトル登場キャラクター一覧
- mainchar_integer_list.csv 整数タイトル自機キャラクター一覧
- bosslist.csv 整数タイトルボスキャラクター一覧
- bookchar_list.csv 書籍のみ登場キャラクター一覧
- hifuu_list.csv 秘封倶楽部キャラクター一覧
- misc_chars.csv その他のキャラクター一覧

- music_noninteger_title.csv 非整数タイトル楽曲一覧
