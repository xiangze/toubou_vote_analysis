...
選択式でキャラクター(人妖)、音楽、作品に対してそれぞれ7,10,5票入れることができ特に推しには2票入れられます。これは
(())
...
で https://toho-vote.info/result のデータと東方Wiki http://thwiki.info 東方元ネタWiki 2nd https://seesaawiki.jp/toho-motoneta_2nd/ 
の楽曲、キャラの登場作品、面、自機に関する情報を結合して、解析コードとそれによって整形されたデータはgithubのdata以下に置いてあります。

- data/title_points.csv
- data/char_points.csv
- data/music_points.csv
