...
ax.scatter(
        x=musictitlerate_vs_titlerate["作品ポイント比率"],
        y=musictitlerate_vs_titlerate["音楽集計ポイント比率"] ,       
        c=cm(musictitlerate_vs_titlerate["名前n"]))#,figsize=(10,10))
w(fig)
...
ax = fig.add_subplot(1,1,1)
ax.scatter(
        x=chartitlerate_vs_musictitlerate["音楽集計ポイント比率"],
        y=chartitlerate_vs_musictitlerate["キャラ集計ポイント比率"],
        c=cm(chartitlerate_vs_musictitlerate["回n"]))
w(fig)
...
ax.scatter(
        x=chartitlerate_vs_musictitlerate["音楽集計ポイント比率"],
        y=chartitlerate_vs_musictitlerate["キャラ集計ポイント比率"],
        c=cm(chartitlerate_vs_musictitlerate["名前n"]))
w(fig)
